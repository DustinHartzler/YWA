...
/**
* FileIcon Bean
* @author Dharamdev <dharamdev.d@smartbuzz.net>
* @version 1.3
* 
...
//	'xxxx' => array('project', 'Project Document'), 	// dont remember type...
	...
	'wav' => array('audio', 'WAV Audio'),
	'aac' => array('audio', 'AAC Audio'),
	...
	// Video
	'mpeg' => array('mpeg_video', 'MPEG Video'),
	'mpg' => array('mpeg_video', 'MPEG Video'),
	'mpe' => array('mpeg_video', 'MPEG Video'),
	'wmv' => array('media_video', 'Windows Media File'),
	'avi' => array('avi_video', 'AVI Video'),
	'flv' => array('flv_video', 'FLV Video'),
	'mp4' => array('mp4_video', 'MP4 Video'),
	'mov' => array('mp4_video', 'mov Video'),
	'movie' => array('mp4_video', 'movie Video'),
	...
	*/	
	function displayIcon() {
		$array = $this -> getIcon();
		return '<img src="'.plugins_url()."/membership-simplified-for-oap-members-only/" . $this -> url . $array[0] . '.gif" alt="' . $array[1] . '" />';
	}
