...
$options[] = array( 'name' => __( 'Section Title', 'woothemes' ),
                    'desc' => __( 'Title for the Featured Products section.', 'woothemes' ),
                    'id' => $shortname . '_homepage_featured_products_title',
                    'std' => __('Staff Picks', 'woothemes'),
                    'type' => 'text' );

$options[] = array( 'name' => __( 'Section Byline', 'woothemes' ),
                    'desc' => __( 'Byline for the Featured Productts section.', 'woothemes' ),
                    'id' => $shortname . '_homepage_featured_products_byline',
                    'std' => __('Featured Products', 'woothemes'),
                    'type' => 'text' );

$options[] = array( 'name' => __( 'Number of Featured Products', 'woothemes' ),
                    'desc' => __( 'Number of Featured Products to display.', 'woothemes' ),
