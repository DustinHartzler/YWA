...
$default_google_fonts = array( 'Cabin', 'Raleway' );
...
add_action( 'wp_print_styles', 'woo_load_google_fonts' );

if ( ! function_exists( 'woo_load_google_fonts' ) ) {
	function woo_load_google_fonts() {

		wp_register_style('woo_google_fonts', 'http://fonts.googleapis.com/css?family=Raleway:400,500,700|Cabin:400,500,700');
		wp_enqueue_style( 'woo_google_fonts');
...
/* Add social fields to user profile. */
/*-----------------------------------------------------------------------------------*/
if ( ! function_exists( 'woo_profile_social' ) ) {
	function woo_profile_social_fields ( $fields ) {
		// Add new fields
		$fields['twitter'] = __('Twitter Username', 'woothemes');
		$fields['facebook'] = __('Facebook URL', 'woothemes');
		$fields['gplus'] = __('Google+ URL', 'woothemes');
		return $fields;
	}
}
add_filter('user_contactmethods', 'woo_profile_social_fields');
...
add_action( 'homepage', 'woo_display_intro_message', 10 );
if (!function_exists('woo_display_intro_message')) {
	function woo_display_intro_message() {
		get_template_part( 'includes/homepage/intro-message' );
	}
}
...
add_action( 'homepage', 'woo_display_popular_posts', 20 );
if (!function_exists('woo_display_popular_posts')) {
	function woo_display_popular_posts() {
		get_template_part( 'includes/homepage/popular-posts' );
	}
}
...
if (!function_exists('woo_display_testimonials')) {
	function woo_display_testimonials() {
		if ( class_exists( 'Woothemes_Testimonials' ) ) {
			get_template_part( 'includes/homepage/testimonials' );
		}
	}
}
...
add_action( 'homepage', 'woo_display_sensei', 40 );
if (!function_exists('woo_display_sensei')) {
	function woo_display_sensei() {
		if ( class_exists( 'Woothemes_Sensei' ) ) {
			get_template_part( 'includes/homepage/sensei' );
		}
	}
}
...
add_action( 'homepage', 'woo_display_recent_posts', 50 );
if (!function_exists('woo_display_recent_posts')) {
	function woo_display_recent_posts() {
		get_template_part( 'includes/homepage/recent-posts' );
	}
}
...
add_action( 'homepage', 'woo_display_our_team', 60 );
if (!function_exists('woo_display_our_team')) {
	function woo_display_our_team() {
		if ( class_exists( 'Woothemes_Our_Team' ) ) {
			get_template_part( 'includes/homepage/our-team' );
		}
	}
}
...
add_action( 'homepage', 'woo_display_featured_products', 70 );
if (!function_exists('woo_display_featured_products')) {
